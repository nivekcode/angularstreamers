...
export const STREAMERS: Streamer[] = [
  ...
  {
    name: 'Chau Tran',
    description: 'I am a developer who is highly interested in TypeScript. My tech stack has been full-stack TS such as Angular, React with TypeScript and NestJS.',
  ...
  {
    name: 'Jason Warner',
    description: 'I enjoy everything related to code and being a dev. However, my only skills are showing up and being lucky and I\'m not sure if luck is a talent.',
  ...
  {
    name: 'webdave',
    description: 'I am an Angular consultant and trainer with a passion: sharing knowledge. I love to speak and teach at meetups and conferences. I am also an organizer of the Hamburg Angular Meetup and a GDE in Angular.',
